  ...
  constructor() {
    ...
    <main id="park" class="component bg-white rounded-4 shadow-lg p-4">
      ...
      <form id="park_form" class="d-flex gap-2 justify-content-evenly mt-5">
        <input maxlength="10" autofocus class="flex-grow-1 px-2 py-1 rounded-2 border-1" type="text" name="registration" id="registration" placeholder="Car's Registration Number..." required>
